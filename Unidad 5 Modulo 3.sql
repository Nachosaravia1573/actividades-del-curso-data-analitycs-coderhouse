...
-- Al id de productolee un autoincremental de uno en uno, numero entero y la clave priamria
nombre_producto VARCHAR(100),
categoria VARCHAR(50),
-- En el caso de el nombre del producto y la categoria el comando varchar es util ya que permite contenidos alfanumericos
precio_unitario DECIMAL(10,2),
stock_actual INT,
stock_minimo INT,
-- Para el caso de el stock, que es  la cantidad que posee la empresa del producto, un numero entero es correcto.
fecha_ingreso DATE,
activo TINYINT
) ;
